...
\begin{multicols*}{3}
  ...
  \begin{itemize}
    \item $F(x) = P(X \leq x) = \frac{1}{\sqrt{2 \pi}} \int^x_{-\infty} e^{-\frac{1}{2}y^2} \mathop{dy} = \Phi(x)$
  \end{itemize}
  ...
  \begin{minipage}[c]{0.65\linewidth}
    \begin{tightcenter}
      ...
      $P(X < a) = \int^a_0 \lambda e^{-\lambda x} \dx = 1 - e^{-\lambda a}$
    \end{tightcenter}
  \end{minipage}
  ...
  \begin{enumerate}
    ...
    \begin{itemize}
      \item $X \sim Normal(\mu, \sigma^2), \quad M(t) = e^{\frac{\sigma^2 t^2}{2} + \mu t}$
